(() => {
  ...
  const API_URL = 'https://api.github.com/repos/jonathanperis/rinha2-back-end-go/contents/docs/reports?ref=main';
  const BASE_URL = 'https://jonathanperis.github.io/rinha2-back-end-go/reports/';
